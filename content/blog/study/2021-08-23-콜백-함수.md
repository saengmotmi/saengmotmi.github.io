...
callback 패턴과 Promise를 활용하여 delay의 타입을 체크하는 간단한 setTimeout 함수를 만들어보았다.
...
Web API를 통해 비동기 작업을 해야 하는 경우에도 빈번히 사용된다. 다음은 `window.requestAnimationRequest()`의 예시 코드다.
